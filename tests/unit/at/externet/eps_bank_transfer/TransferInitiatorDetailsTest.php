...
class TransferInitiatorDetailsTest extends BaseTest
{
    public function testGenerateTransferInitiatorDetails()
    {
        ...
        $data = new TransferInitiatorDetails('AKLJS231534', 'topSecret', 'GAWIATW1XXX', 'Max Mustermann', 'AT611904300234573201', '1234567890ABCDEFG', 'AT1234567890XYZ', 15000, $transferMsgDetails, '2007-03-16');
